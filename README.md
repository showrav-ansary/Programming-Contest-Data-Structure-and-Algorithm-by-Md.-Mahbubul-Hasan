...
You are requested to create an `issue` first if you want to add any solution. You are more than welcome to create a `Pull request` if you want to add solutions of your own or want add a new paradigm to any already existing solution. It is requested that you explain a solution as vividly as possible, as detailed as possible. You can write down pseudo code too or solution in any of your preferred language.
