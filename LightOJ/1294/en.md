...
__Caution__ : Remember, we need `long` or similar data type that can hold integer values more than 10<sup>9</9> because even if `n` and `m` alone does not need any data type more than 10<sup>9</9>, but `n*m` does!
